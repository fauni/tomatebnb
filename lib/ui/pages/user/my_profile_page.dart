    ...
    return Scaffold(
          ...
          builder: (context, state) {
            ...
            return AppButton(
                ...
                onclick: () {
                  ...
                  reqUser.profilePhoto = _profilePhotoController.text;
                  reqUser.documentNumber = _documentNumberController.text;
                  reqUser.documentType = _documentTypeController.text;
                  reqUser.documentPhotoFront =
                      _documentPhotoFrontController.text;
                  reqUser.documentPhotoBack = _documentPhotoBackController.text;
                  reqUser.confirmPhoto = _confirmPhotoController.text;
                  reqUser.recordDate = user.recordDate;
                  reqUser.verified = user.verified;
                  reqUser.status = user.status;
                  context.read<UserBloc>().add(UserUpdateEvent(reqUser));
                },
                context: context);
          },
        ),
      ...
      body: BlocConsumer<UserBloc, UserState>(listener: (context, state) {
        ...
        if (state is UserGetByIdSuccess) {
          ...
          _profilePhotoUrlController.text = user.profilePhotoUrl ?? "";
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            listener: (context, state) {
                              ...
                              if (state is UserUnsubscribeSuccess) {
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(SnackBar(
                              ...
                              if (state is UserUnsubscribeError) {
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(SnackBar(
                                  content: Text(state.message),
                                  backgroundColor:
                            ...
                            builder: (context, state) {
                              if (state is UserUnsubscribeLoading) {
                                return Center(
                                    child: CircularProgressIndicator());
                              }
                              return TextButton(
                                onPressed: () {
                                  bottomsheetUnsubscribe();
                                },
                      ...
                      Stack(
                        children: [
                          user.documentPhotoFront != null &&
                                  user.documentPhotoFront != ""
                              ? FadeInImage.assetNetwork(
                                  image: '${user.documentPhotoFrontUrl}',
                      ...
                      Stack(
                        children: [
                          user.documentPhotoBack != null &&
                                  user.documentPhotoBack != ""
                              ? FadeInImage.assetNetwork(
                                  image: '${user.documentPhotoBackUrl}',
                                  placeholder: "assets/images/load.gif",
                                )
                              : Center(
                                  child: Image.asset(
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            Text(
                              "Tus datos seran eliminados en 30 dias",
                              style: TextStyle(
                                  fontSize: 15,
                                  color: Theme.of(context).colorScheme.primary,
                                  fontFamily: "Gilroy Bold"),
