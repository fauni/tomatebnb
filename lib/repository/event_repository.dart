...
Future<ApiResponse<EventResponseModel>> createEvent(EventRequestModel reserve) async {
    try{
  ...
  // Future<api_response_list.ApiResponse<EventResponseModel>> getByUser() async {
  //   try{
  //     final prefs = await SharedPreferences.getInstance();
  //     int userId = prefs.getInt("userId")??0;
  //     String token = prefs.getString("token")??"";
